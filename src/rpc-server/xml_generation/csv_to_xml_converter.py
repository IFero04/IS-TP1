...
from xml_generation.entities.team import Team
from xml_generation.entities.player import Player
from xml_generation.entities.college import College
from xml_generation.entities.entry import Entry
